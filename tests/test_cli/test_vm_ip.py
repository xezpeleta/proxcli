"""Unit tests for VM IP CLI command."""
...
class TestVMIPCLI:
    def test_vm_ip_dry_run(self, tmp_path, monkeypatch):
        """vm ip does a GET dry-run to the guest agent interface."""
        ...
        assert "agent/network-get-interfaces" in result.stdout
